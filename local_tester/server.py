...
from app.a2ui_config import process_a2ui_response
                        ...
                        "surfaceUpdate": {
                            ...
                            "components": [
                                ...
                                },
                                {
                                    ...
                                    "component": {
                                        "Column": {
                                            "children": { "explicitList": ["card_title", "card_body", "action_btn"] }
                                        }
                                    }
                                },
                                {
                                    ...
                                    "component": {
                                        "Text": {
                                            "text": { "literalString": "⚡ Simple A2UI Local Test Card" },
                                            "usageHint": "h1"
                                        }
                                    }
                                },
                                {
                                    ...
                                    "component": {
                                        "Text": {
                                            "text": { "literalString": "This verifies that A2UI surface rendering, component graph traversal, and A2A JSON-RPC extensions are working correctly!" },
                                            "usageHint": "body"
                                        }
                                    }
                                },
                                    ...
                                    "component": {
                                        "Button": {
                                            ...
                                            "action": {
                                                "name": "reorder_beans",
                                                "context": [
                                                    { "key": "message", "value": { "literalString": "Reorder 50kg Coffee Beans" } }
                                                ]
                                            }
                                        }
                                    }
                                },
                                {
                                    "id": "btn_label",
                                    "component": {
                                        "Text": { "text": { "literalString": "🛒 Reorder 50kg Beans" } }
                                    }
                                }
                            ]
                        }
                ...
                "result": {
                    "message": {
                        "parts": [
                            ...
                            { "data": sample_a2ui, "metadata": { "mimeType": "application/json+a2ui" } }
                        ]
                    }
                },
                "id": request_id
